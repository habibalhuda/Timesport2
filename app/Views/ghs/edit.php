            ...
            <div class="col-8">
                  <div class="card">
                        <div class="card-header">
                              <h2 class="my-3">Form Ubah Data GameHouse</h2>
                        </div>
                        <div class="card-body">
                              <?=$validation->listErrors();?>
                              <form action="/Ghs/update/<?= $ghs['id']; ?>" method="post" enctype="multipart/form-data">
                                    <?=csrf_field();?>
                                    <input type="hidden" name="id" value="<?= $ghs['id']; ?>">
                                    <input type="hidden" name="profileLama" value="<?= $ghs['profile']; ?>">
                                    <div class="mb-3">
                                          <label for="nama" class="form-label">Nama</label>
                                          <input type="text"
                                                class="form-control <?=( $validation->hasError( 'nama' ) ) ? 'is-invalid' : '';?>"
                                                id="nama" autofocus name="nama"
                                                value="<?=(old( 'nama' ))? old('nama'):$ghs['nama'];?>">
                                    ...
                                    <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" name="alamat" id="alamat"
                                                value="<?=(old( 'alamat'))? old('alamat'):$ghs['alamat'];?>">
                                    </div>
                                    <div class="mb-3">
                                          <label for="region" class="form-label">Region</label>
                                          <select name="region" id="region" class='form-control'
                                                value="<?=(old( 'region'))? old('region'):$ghs['region'];?>">
                                    ...
                                    <div class="form-group-row">
                                          ...
                                          <div class='mb-3'>
                                                ...
                                                <input type="number" class="form-control" name="jumlah_slot"
                                                      id="jumlah_slot"
                                                      value="<?=(old( 'jumlah_slot'))? old('jumlah_slot'):$ghs['jumlah_slot'];?>">
                                          </div>
                                          ...
                                          <fieldset class="form-group mb-3" id='input_reward' style='display:none'>
                                                ...
                                                <input type="number" class="form-control" id="prize_pool"
                                                      ...
                                                      value="<?=(old( 'prize_pool'))? old('prize_pool'):$ghs['prize_pool'];?>">

                                                <label for="1st">1st</label>
                                                <input type="number" class="form-control" id="1st"
                                                      placeholder="Lebih lengkap" name='1st'
                                                      value="<?=(old( '1st'))? old('1st'):$ghs['1st'];?>">

                                                <label for="2nd">2nd</label>
                                                <input type="number" class="form-control" id="2nd"
                                                      placeholder="Lebih lengkap" name='2nd'
                                                      value="<?=(old( '2nd'))? old('2nd'):$ghs['2nd'];?>">

                                                <label for="3rd">3rd</label>
                                                <input type="number" class="form-control" id="3rd"
                                                      placeholder="Lebih lengkap" name='3rd'
                                                      value="<?=(old( '3rd'))? old('3rd'):$ghs['3rd'];?>">
                                          ...
                                          <div class="mb-3">
                                                ...
                                                <input type="textarea" class="form-control" name="deskripsi"
                                                      id="deskripsi"
                                                      value="<?=(old( 'deskripsi'))? old('deskripsi'):$ghs['deskripsi'];?>">
                                          </div>
                                          <fieldset class="form-group my-5">
                                                <div class="form-check form-switch row-10">
                                                      ...
                                                      <label class="form-check-label fs-5 ml-6 mt-3"
                                          ...
                                          <fieldset class="form-group mb-3" id="rulesinput" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" name="rules"
                                                      value="<?=(old( 'rules'))? old('rules'):$ghs['rules'];?>">
